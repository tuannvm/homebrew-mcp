  class KafkaMcpServer < Formula
    ...
    on_macos do
      on_arm do
        url "https://github.com/tuannvm/kafka-mcp-server/releases/download/v1.0.3/1.0.0_1.0.3_darwin_arm64.tar.gz"
        sha256 "3c4d19889f136e5554dc15c7e86846f88b112aefce5654fdc291b1baffd5a3ea"
      end
      on_intel do
        url "https://github.com/tuannvm/kafka-mcp-server/releases/download/v1.0.3/1.0.0_1.0.3_darwin_amd64.tar.gz"
    ...
    on_linux do
      on_arm do
        url "https://github.com/tuannvm/kafka-mcp-server/releases/download/v1.0.3/1.0.0_1.0.3_linux_arm64.tar.gz"
        sha256 "751a6aaec9fb09ccef884a9845a2b1275fd6cda87cb104ef79c2bf7fc2d3cb11"
      end
      on_intel do
        url "https://github.com/tuannvm/kafka-mcp-server/releases/download/v1.0.3/1.0.0_1.0.3_linux_amd64.tar.gz"
